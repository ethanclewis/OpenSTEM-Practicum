...
# Define GPIO pin addresses for each zone sensor
sensor_pins = {
    "Zone 1": 24,
    "Zone 2": 17,
    "Zone 3": 18
...
# File path for confirmation/ error logging
...
for zone_name, pin in sensor_pins.items():
    ...
    if temperature is not None and humidity is not None:
        ...
        log_message(f"{zone_name}: Sensor failure. Check wiring.")
